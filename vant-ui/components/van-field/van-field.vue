<template>
	<view class="van-cell van-field" :class="[disabled ? 'van-field--disabled' : '', required ? 'van-cell--required' : '', error ? 'van-field--error' : '']">
		<view class="van-field__left-icon" v-if="leftIcon"><van-icon :name="leftIcon" size="40rpx"></van-icon></view>
		...
		<view class="van-cell__value van-field__value">
			<view class="van-field__body">
				...
				<van-icon v-if="clearable && clearIconShow" class="van-field__clear" name="clear" size="38rpx" @click.stop="clickClearIcon"></van-icon>

				<view class="van-field__button" v-if="$slots.button"><slot name="button"></slot></view>

				<view class="van-field__right-icon" v-if="rightIcon" @click.stop="clickRightIcon"><van-icon :name="rightIcon" size="40rpx"></van-icon></view>
			</view>
