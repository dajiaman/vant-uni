<template>
  <view>
    <van-popup :zoom="zoom" position="center" :popup="false" :z-index="uZIndex" v-model="value" :length="width"
      :overlay="overlay" :maskCloseable="closeOnClickOverlay" :border-radius="borderRadius" @close="popupClose">
      <view class="van-dialog">
        ...
        <view class="van-dialog__content">
          ...
          <view v-else class="van-dialog__message" :class="[
        ...
        <view class="van-hairline--top van-dialog__footer van-dialog__footer--buttons"
          ...
          <van-button v-if="showCancelButton" size="large" class="van-dialog__cancel" @tap="cancel">{{ cancelText }}
          </van-button>


          <van-button v-if="showConfirmButton" size="large" class="van-dialog__confirm van-hairline--left"
            :open-type="confirmButtonOpenType" @tap="confirm">{{ confirmText }}
          </van-button>
