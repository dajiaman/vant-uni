<template>
    <view class="van-waterfall">
        <view id="van-left-cloumn" class="van-cloumn">
            <slot name="left" :leftList="leftList"></slot>
        </view>
        <view id="van-right-cloumn" class="van-cloumn">
    ...
    export default {
        ...
        methods: {
            async splitData() {
                ...
                let leftRect = await this.$uGetRect('#van-left-cloumn');
                let rightRect = await this.$uGetRect('#van-right-cloumn');
