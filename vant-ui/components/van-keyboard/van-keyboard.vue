<template>
	<van-popup class="" :mask="mask" :maskCloseAble="maskCloseAble" position="bottom" :popup="false" v-model="value" length="auto"
	 :safeAreaInsetBottom="safeAreaInsetBottom" @close="popupClose">
		...
		<block v-if="mode == 'number' || mode == 'card'">
			<van-number-keyboard :random="random" @backspace="backspace" @change="change" :mode="mode" :dotEnabled="dotEnabled"></van-number-keyboard>
		</block>
		<block v-else>
			<van-car-keyboard :random="random" @backspace="backspace" @change="change"></van-car-keyboard>
		</block>
	</van-popup>
</template>
