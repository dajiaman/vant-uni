<template>
	<view class="van-toast" :class="[isShow ? 'van-toast-show' : '', 'van-toast--' + config.type, 'van-toast--' + config.position]" style="z-index: 2009;">
		
		<van-icon :name="config.type" v-if="showIcon" size="70rpx"></van-icon>
