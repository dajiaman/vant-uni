<template>
	<view class="container">
		...
		<van-swipe-cell :actions="actions" @click="handlerButton">
		...
		<van-swipe-cell :actions="actions2" :closable="false" @click="handlerButton2">
			<template v-slot:content>
		...
		<van-swipe-cell :actions="actions2" :closable="false" forbid @click="handlerButton2">
			<template v-slot:content>
		...
		<van-swipe-cell :actions="actions2" :open="open" @click="handlerButton2">
			<template v-slot:content>
		...
		<van-swipe-cell :actions="actions2" :showMask="false" @click="handlerButton2">
			<template v-slot:content>
		...
		<van-swipe-cell :operateWidth="140">
			<template v-slot:content>
				<view class="tui-list-item">自定义操作菜单，不传actions</view>
			</template>
			<template v-slot:button>
				<view class="tui-custom-btn_box">
					<view class="tui-custom-btn tui-custom-mr" @tap="customBtn(0)">
						<van-icon name="star" color="#333" :size="20"></van-icon></view>
					<view class="tui-custom-btn" @tap="customBtn(1)"><van-icon name="delete" color="#333" :size="18"></van-icon></view>
				</view>
			</template>
		</van-swipe-cell>
	</view>
