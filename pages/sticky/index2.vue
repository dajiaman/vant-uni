<template>
	<view class="container">
		<view class="tips">
			...
			<view @tap="sticky(1)">
				3、
				<text class="tui-color-primary">查看基本示例</text>
			</view>
			<view @tap="sticky(2)">
				4、
				<text class="tui-color-primary">查看异步加载示例</text>
			</view>
			<!-- #ifdef APP-PLUS || H5 || MP-WEIXIN -->
			<view @tap="sticky(3)">
				5、
				<text class="tui-color-primary">wxs吸顶示例</text>
			</view>
			<!-- #endif -->
		</view>
		<van-sticky :scrollTop="scrollTop" stickyHeight="104rpx" container>
			...
			<template v-slot:content>
				...
				<view class="list-view">
					<view class="tui-list-item" hover-class="tui-hover" :hover-stay-time="150" @tap="detail">
						...
						<view class="money add">+0.07</view>
					</view>
					...
					<view class="tui-list-item" hover-class="tui-hover" :hover-stay-time="150" @tap="detail">
						...
						<view class="money">-20190604.07</view>
					</view>
					...
					<view class="tui-list-item item-last" hover-class="tui-hover" :hover-stay-time="150" @tap="detail">
						...
						<view class="money add">+66668666.00</view>
					</view>
				</view>
				<!--内容 end-->
			</template>
			...
			<template v-slot:content>
				...
				<view class="tui-list-view">
					...
					<view class="tui-list-item" hover-class="tui-hover" :hover-stay-time="150" @tap="detail">
						...
						<view class="money">-201906.07</view>
					</view>
...
export default {
	...
	methods: {
		...
		sticky(type) {
			let url = '/pages/sticky/index';

			if (type == 2) {
				url = '/pages/sticky/async';
			} else if (type == 3) {
