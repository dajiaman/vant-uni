<template>
	<view class="container">
		...
		<van-sticky :recalc="recalc" :scrollTop="scrollTop" stickyHeight="104rpx" container>
		...
		<van-sticky :recalc="recalc" :scrollTop="scrollTop" stickyHeight="104rpx">
			<template v-slot:header>
				<view class="sticky-item ">
		...
		<van-loadmore v-if="loading"></van-loadmore>
	</view>
</template>
